  ...
  Models.User.scope("withPassword")
    ...
    .then((data) => {
      ...
      if (
        ...
        data[0].dataValues.password = undefined; //removes the key from the response (postman response will show hashed pass) -- just for fun comment this to show hashed password stored in the
